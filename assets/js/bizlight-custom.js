    ...
    jQuery(window).on('scroll', function () {
        ...
        if (stickyHeaderTop >= 30) {
            if (!$('.navbar-fixed-top').hasClass("navbar-fixed-active")) {
                ...
                $('.navbar-fixed-top').removeClass("navbar-fixed-shadow");
            }
            if (!$('.navbar-info').hasClass("navbar-info-hide")) {
                $('.navbar-info').addClass("navbar-info-hide");
                $('.navbar-info').removeClass("navbar-info-show");
            }
        } else {
            $('.navbar-fixed-top').addClass("navbar-fixed-shadow");
            $('.navbar-fixed-top').removeClass("navbar-fixed-active");
            $('.navbar-info').addClass("navbar-info-show");
            $('.navbar-info').removeClass("navbar-info-hide");
        }
    });
