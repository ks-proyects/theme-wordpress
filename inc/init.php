...
$keysist_hooks_homepage_caracteristicas_file_path = keysist_file_directory('inc/hooks/homepage-caracteristicas.php');
require $keysist_hooks_homepage_caracteristicas_file_path;
...
$keysist_hooks_homepage_aboutus_file_path = keysist_file_directory('inc/hooks/homepage-aboutus.php');
require $keysist_hooks_homepage_aboutus_file_path;
