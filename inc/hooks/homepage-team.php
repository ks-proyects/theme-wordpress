...
if (!function_exists('keysist_home_team_array')) :
    ...
    function keysist_home_team_array(){
        ...
        if ($keysist_home_testimonial_post_query->have_posts()):
            ...
            $bizlight_home_testimonial_contents_array[0]['bizlight-home-team-content'] = __("The set doesn't moved. Deep don't fru it fowl gathering heaven days moving creeping under from i air. Set it fifth Meat was darkness. every bring in it.",'bizlight');
            ...
            $bizlight_home_testimonial_contents_array[1]['bizlight-home-team-content'] = __("The set doesn't moved. Deep don't fru it fowl gathering heaven days moving creeping under from i air. Set it fifth Meat was darkness. every bring in it.",'bizlight');
